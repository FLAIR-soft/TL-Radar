const ru = {
  ...
  taskForm: {
    ...
    iconHint: 'Выберите значок — он появится на карточке и в календаре.',
    groupingEyebrow: 'Отнесение',
    timeEyebrow: 'Время',
    deadlineInPast: 'Дата в прошлом — задача сразу станет просроченной',
    presetDay: '1 день',
  ...
  wipLimits: {
    ...
    noLimit: 'без лимита',
    fullWarning: '«{status}» сейчас заполнена — {n} из {limit} задач.',
    save: 'Сохранить',
  ...
  recurring: {
    ...
    subtitle: 'Создаются из шаблона автоматически — по будням, еженедельно или ежемесячно.',
  ...
  projects: {
    ...
    editEyebrow: 'Редактирование проекта',
    taskCount: {
      one: '{n} задача',
      few: '{n} задачи',
      many: '{n} задач',
  ...
  analytics: {
    title: 'Аналитика',
    subtitle:
      'Время на задачах по каждому в сравнении с доступным рабочим временем (07:30–16:00).',
    empty: 'Пока нет зарегистрированных пользователей.',
    workedLabel: 'Отработано',
    availableLabel: 'Доступно',
    colPerson: 'Человек',
    colWorked: 'Отработано',
    colPercent: '% доступного времени',
    workedEyebrow: 'Отработано · % доступного времени',
    availableInRange: 'Доступно за период',
    estimateAccuracyColDistribution: 'Отклонение от оценки',
    periodLabels: {
      7: '7 дней',
      30: '30 дней',
      90: '90 дней',
  ...
  landing: {
    ...
    feature3Desc: 'Сколько свободной ёмкости остаётся у каждого человека относительно доступных часов.',

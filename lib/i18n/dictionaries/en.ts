...
const en = {
  ...
  taskCard: {
    ...
    overdueSince: {
      ...
      few: 'Overdue by {n} days',
      many: 'Overdue by {n} days',
  ...
  taskForm: {
    ...
    iconHint: 'Pick an icon — it shows on the card and in the calendar.',
    groupingEyebrow: 'Classification',
    timeEyebrow: 'Time',
    deadlineInPast: 'In the past — the task starts out overdue',
    presetDay: '1 day',
    title: 'Task title',
  ...
  recurring: {
    ...
    subtitle: 'Created from a template automatically — on weekdays, weekly or monthly.',
    empty: 'No rules yet.',
  ...
  landing: {
    ...
    feature3Desc: 'How much free capacity each person still has against their available hours.',

...
const de = {
  ...
  taskForm: {
    ...
    iconHint: 'Symbol wählen — es erscheint auf der Karte und im Kalender.',
    groupingEyebrow: 'Einordnung',
    timeEyebrow: 'Zeit',
    deadlineInPast: 'Liegt in der Vergangenheit — Aufgabe startet als überfällig',
    presetDay: '1 Tag',
    title: 'Aufgabentitel',
